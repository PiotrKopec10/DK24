...
namespace GUSAPI
{
    ...
    public interface IUslugaBIRzewnPubl
    {
        ...
        System.Threading.Tasks.Task<GUSAPI.GetValueResponse> GetValueAsync(GUSAPI.GetValueRequest request);
        ...
        System.Threading.Tasks.Task<GUSAPI.ZalogujResponse> ZalogujAsync(GUSAPI.ZalogujRequest request);
        ...
        System.Threading.Tasks.Task<GUSAPI.WylogujResponse> WylogujAsync(GUSAPI.WylogujRequest request);
        ...
        System.Threading.Tasks.Task<GUSAPI.DaneSzukajPodmiotyResponse> DaneSzukajPodmiotyAsync(GUSAPI.DaneSzukajPodmiotyRequest request);
        ...
        System.Threading.Tasks.Task<GUSAPI.DanePobierzPelnyRaportResponse> DanePobierzPelnyRaportAsync(GUSAPI.DanePobierzPelnyRaportRequest request);
        ...
        System.Threading.Tasks.Task<GUSAPI.DanePobierzRaportZbiorczyResponse> DanePobierzRaportZbiorczyAsync(GUSAPI.DanePobierzRaportZbiorczyRequest request);
    }
    ...
    public partial class DaneSzukajPodmiotyRequest
    {
        ...
        [System.ServiceModel.MessageBodyMemberAttribute(Namespace="http://CIS/BIR/PUBL/2014/07", Order=0)]
        public GUSAPI.ParametryWyszukiwania pParametryWyszukiwania;
        
        public DaneSzukajPodmiotyRequest()
        {
        }
        
        public DaneSzukajPodmiotyRequest(GUSAPI.ParametryWyszukiwania pParametryWyszukiwania)
        {
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.1.0")]
    public interface IUslugaBIRzewnPublChannel : GUSAPI.IUslugaBIRzewnPubl, System.ServiceModel.IClientChannel
    {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.1.0")]
    public partial class UslugaBIRzewnPublClient : System.ServiceModel.ClientBase<GUSAPI.IUslugaBIRzewnPubl>, GUSAPI.IUslugaBIRzewnPubl
    {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<GUSAPI.GetValueResponse> GUSAPI.IUslugaBIRzewnPubl.GetValueAsync(GUSAPI.GetValueRequest request)
        {
            return base.Channel.GetValueAsync(request);
        }
        
        public System.Threading.Tasks.Task<GUSAPI.GetValueResponse> GetValueAsync(string pNazwaParametru)
        {
            GUSAPI.GetValueRequest inValue = new GUSAPI.GetValueRequest();
            inValue.pNazwaParametru = pNazwaParametru;
            return ((GUSAPI.IUslugaBIRzewnPubl)(this)).GetValueAsync(inValue);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<GUSAPI.ZalogujResponse> GUSAPI.IUslugaBIRzewnPubl.ZalogujAsync(GUSAPI.ZalogujRequest request)
        {
            return base.Channel.ZalogujAsync(request);
        }
        
        public System.Threading.Tasks.Task<GUSAPI.ZalogujResponse> ZalogujAsync(string pKluczUzytkownika)
        {
            GUSAPI.ZalogujRequest inValue = new GUSAPI.ZalogujRequest();
            inValue.pKluczUzytkownika = pKluczUzytkownika;
            return ((GUSAPI.IUslugaBIRzewnPubl)(this)).ZalogujAsync(inValue);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<GUSAPI.WylogujResponse> GUSAPI.IUslugaBIRzewnPubl.WylogujAsync(GUSAPI.WylogujRequest request)
        {
            return base.Channel.WylogujAsync(request);
        }
        
        public System.Threading.Tasks.Task<GUSAPI.WylogujResponse> WylogujAsync(string pIdentyfikatorSesji)
        {
            GUSAPI.WylogujRequest inValue = new GUSAPI.WylogujRequest();
            inValue.pIdentyfikatorSesji = pIdentyfikatorSesji;
            return ((GUSAPI.IUslugaBIRzewnPubl)(this)).WylogujAsync(inValue);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<GUSAPI.DaneSzukajPodmiotyResponse> GUSAPI.IUslugaBIRzewnPubl.DaneSzukajPodmiotyAsync(GUSAPI.DaneSzukajPodmiotyRequest request)
        {
            return base.Channel.DaneSzukajPodmiotyAsync(request);
        }
        
        public System.Threading.Tasks.Task<GUSAPI.DaneSzukajPodmiotyResponse> DaneSzukajPodmiotyAsync(GUSAPI.ParametryWyszukiwania pParametryWyszukiwania)
        {
            GUSAPI.DaneSzukajPodmiotyRequest inValue = new GUSAPI.DaneSzukajPodmiotyRequest();
            inValue.pParametryWyszukiwania = pParametryWyszukiwania;
            return ((GUSAPI.IUslugaBIRzewnPubl)(this)).DaneSzukajPodmiotyAsync(inValue);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<GUSAPI.DanePobierzPelnyRaportResponse> GUSAPI.IUslugaBIRzewnPubl.DanePobierzPelnyRaportAsync(GUSAPI.DanePobierzPelnyRaportRequest request)
        {
            return base.Channel.DanePobierzPelnyRaportAsync(request);
        }
        
        public System.Threading.Tasks.Task<GUSAPI.DanePobierzPelnyRaportResponse> DanePobierzPelnyRaportAsync(string pRegon, string pNazwaRaportu)
        {
            GUSAPI.DanePobierzPelnyRaportRequest inValue = new GUSAPI.DanePobierzPelnyRaportRequest();
            inValue.pRegon = pRegon;
            inValue.pNazwaRaportu = pNazwaRaportu;
            return ((GUSAPI.IUslugaBIRzewnPubl)(this)).DanePobierzPelnyRaportAsync(inValue);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<GUSAPI.DanePobierzRaportZbiorczyResponse> GUSAPI.IUslugaBIRzewnPubl.DanePobierzRaportZbiorczyAsync(GUSAPI.DanePobierzRaportZbiorczyRequest request)
        {
            return base.Channel.DanePobierzRaportZbiorczyAsync(request);
        }
        
        public System.Threading.Tasks.Task<GUSAPI.DanePobierzRaportZbiorczyResponse> DanePobierzRaportZbiorczyAsync(string pDataRaportu, string pNazwaRaportu)
        {
            GUSAPI.DanePobierzRaportZbiorczyRequest inValue = new GUSAPI.DanePobierzRaportZbiorczyRequest();
            inValue.pDataRaportu = pDataRaportu;
            inValue.pNazwaRaportu = pNazwaRaportu;
            return ((GUSAPI.IUslugaBIRzewnPubl)(this)).DanePobierzRaportZbiorczyAsync(inValue);
        }
